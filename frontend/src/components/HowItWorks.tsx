...
export const HowItWorks: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: Route,
      tag: 'SYNTHESIS',
      headline: 'Courses → Skills → Projects → Assessments → Milestones',
    ...
    },
    {
      ...
      headline: 'Continuous reinforcement & dynamic pacing',
  ...
  return (
    <section id="how-it-works" className="py-24 md:py-32 bg-[#F9F8F3] dark:bg-[#121211] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 4 Interactive Step Cards with connecting rail */}
            ...
            {steps.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white dark:bg-[#1A1A18] rounded-3xl p-7 border transition-all duration-300 cursor-pointer flex flex-col justify-between ${
                    isCurrent
                      ? 'border-[#FF4D31] shadow-lg shadow-[#FF4D31]/10 -translate-y-1.5 ring-2 ring-[#FF4D31]/20'
