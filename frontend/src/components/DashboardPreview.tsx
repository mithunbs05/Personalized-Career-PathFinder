...
import { ThreeOrb } from './3d/ThreeOrb';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#F9F8F3] dark:bg-[#252522] rounded-full text-[10px] font-bold tracking-widest text-[#7A8B7C] uppercase mb-4 shadow-2xs">
            <Box className="w-3.5 h-3.5 text-[#FF4D31]" />
            <span>THE 3D LEARNER COCKPIT</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-[#1A1A1A] dark:text-white tracking-tight">
            Designed for daily focus and 3D spatial flow.
          </h2>
          <p className="text-base sm:text-lg text-[#4A4A4A] dark:text-[#A0A09B] mt-4">
            A high-contrast, distraction-free environment that renders real-time telemetry, 3D energy cores, and actionable milestones.
          </p>
        </div>

        {/* 3D Tilt Dashboard Mockup Card */}
        <div className="max-w-5xl mx-auto">
          <TiltCard maxTilt={5} scale={1.01}>
            <div className="bg-white dark:bg-[#1A1A18] rounded-3xl border border-[#E8E6DE] dark:border-[#2C2C29] shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 py-3.5 border-b border-[#E8E6DE] dark:border-[#2C2C29] bg-[#F1EFE7]/80 dark:bg-[#1A1A18]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="ml-3 text-xs font-medium text-[#7A8B7C]">app.pathai.dev/dashboard · 3D Spatial</span>
                </div>
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#E8E6DE] dark:border-[#2C2C29]">
                  <div className="flex items-center gap-4">
                    <ThreeOrb progress={68} size={64} />
                    <div>
                      <h3 className="text-2xl font-display font-bold text-[#1A1A1A] dark:text-white flex items-center gap-2">
                        Alex Rivera ✦ Generative AI Engineer
                      </h3>
                      <p className="text-xs sm:text-sm text-[#4A4A4A] dark:text-[#A0A09B] mt-0.5">
                        Target Horizon: <strong className="text-[#1A1A1A] dark:text-white">12 Weeks</strong> • 3D Path Synthesis Active
                      </p>
                    </div>
                  </div>
