...
# ---------------------------------------------------------------------------
app = FastAPI(
    title="PathAI Onboarding, Roadmap & AI Mentor API",
    description=(
        "AI-powered conversational onboarding, adaptive Curriculum Roadmap Timeline, and AI Mentor service using LangChain + GPT-4.1-nano."
    ),
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
